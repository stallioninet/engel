            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-blue-900 text-white p-8 rounded-lg text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/contact">
                    <Button className="bg-white text-blue-900 hover:bg-blue-50" size="lg">
                      Get Free Consultation
                    </Button>
                  </Link>
                  <Link href="/blog">
                    <Button variant="outline" className="border-white text-white hover:bg-white hover:text-blue-900" size="lg">
                      Read More Articles
                    </Button>
                  </Link>
                </div>
